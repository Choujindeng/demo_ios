...
-(void) showBanner {
    if ([[UPArpuAdManager sharedManager] bannerAdReadyForPlacementID:_placementIDs[_name]]) {
        ...
        [self.view addConstraint:[NSLayoutConstraint constraintWithItem:bannerView attribute:NSLayoutAttributeTop relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeTop multiplier:1.0f constant:100.0f]];
