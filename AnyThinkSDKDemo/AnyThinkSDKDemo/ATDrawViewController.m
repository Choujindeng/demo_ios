...
- (void)viewDidLoad {
    ...
    [self.returnBack setImage:[UIImage imageNamed:@"backImage"] forState:UIControlStateNormal];
    [self.view addSubview:self.returnBack];
    
    self.closeButton = [[UIButton alloc]initWithFrame:CGRectMake(self.view.frame.size.width - 50.0f, 20, 50, 50)];
